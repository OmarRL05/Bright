...
Estado actual: **53 respuestas, PASS**, latencia máxima 0.12 ms, y las seis
...
- ~~**El mapa tiene 4 zonas**~~ — **resuelto por Persona 1** en la rama
  `persona1/zonas-shocks-ventanas`, ya integrada aquí: 16 zonas (0–15) y tres
  marcadas (Centro=2, Parque Industrial=11, Linda Vista=15), así que
  `flagged_zone_night` ya se dispara contra los ids de los ejemplos oficiales.
  El ensayo en vivo puede usar la 11. Ojo: eso obligó a **recalibrar los cinco
  umbrales** (`scripts/calibrate.py`), así que los números de `RESULTADOS.md`
  cambiaron — el salario de reserva bajó de $400 a $275/hr.
